...
function create_anticipation($recipient_id,$build,$payment_date,$requested_amount,$array_payable_ids,$pagarme_api_token){

    $curl = curl_init();
    //$payment_date_convert= (1559811600*1000);

    $array_payable_ids_string = implode(",",$array_payable_ids);    
    ...
    CURLOPT_POSTFIELDS => "{\r\n    \"build\": \" ". $build . " \", \r\n    \"payment_date\": \"".$payment_date."\", \r\n\t\"payables\": [". $array_payable_ids_string ."],\r\n\t\"timeframe\": \"start\",\r\n\t\"requested_amount\": ". $requested_amount ." \r\n\r\n}",
